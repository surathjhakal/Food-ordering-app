    ...
    <div class="adminManageContent">
        ...
        <form class="addAdminForm" method="POST" action="">
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $row1['title']?>" name="title" class="form-control" id="exampleInputText1"  placeholder="Enter Your Name">
            </div>
            <div class="form-group">
                <label for="exampleInputImageName1">Image Name</label>
                <input type="text" value="<?php echo $row1['image_name']?>" name="imageName" class="form-control" id="exampleInputImageName1"  placeholder="Enter Image Name">
            </div>
            <div class="form-group">
                <label for="exampleInputActive1">Active</label>
                <input type="text" name="active" value="<?php echo $row1['active']?>" class="form-control" id="exampleInputActive1" placeholder="Active: True or False">
            </div>
